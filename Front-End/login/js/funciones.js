...
function CrearUsuario(){
    ...
    if(nombre.value != '' && apellido.value != '' && fecha.value != '' && genero.value != '' && usuario.value != '' && pass.value != ''){
        ...
        fetch('http://35.222.105.198:5000/registro',{
            method:'POST',
            headers,
...
function IniciarSesion(){
    ...
    if(usuario.value != '' && pass.value != ''){
        fetch(`http://35.222.105.198:5000/login/${usuario.value}/${pass.value}`)
        ...
        .then(data => {
            if(data.nombre == "false"){
                ...
                fetch(`http://35.222.105.198:5000/buscartipousuario/${usuario.value}`)
